...
int Artist::SCREEN_WIDTH = 343;
int Artist::SCREEN_HEIGHT = 287;
...
bool Artist::init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow("OpenComputers Image Tool", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, Artist::SCREEN_WIDTH, Artist::SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
		Artist artist;
...
void Artist::changeRendererColor(int r, int g, int b)
{
