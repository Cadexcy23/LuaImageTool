...
public:
	...
	void drawImage(int x, int y, int w, int h, SDL_Texture* tex, double r = 0, SDL_Point* center = NULL, SDL_RendererFlip flip = SDL_FLIP_NONE, bool scaled = true);

	void drawLetters(std::string string, int x, int y, Artist::fontTextureSet font);

	void changeRendererColor(int r, int g, int b);
